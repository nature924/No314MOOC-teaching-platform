...
public class Article {
	...
	public String toString() {
		return "Article [articleid=" + this.articleid + ", title=" + this.title + ", bannerid=" + this.bannerid
				+ ", image=" + this.image + ", istop=" + this.istop + ", isflv=" + this.isflv + ", contents="
				+ this.contents + ", addtime=" + this.addtime + ", hits=" + this.hits + ", bannername="
				+ this.bannername + "]";
	}
